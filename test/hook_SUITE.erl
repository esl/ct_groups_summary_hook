...
run_original_test(_Config) ->
    ...
    [
        ...
        {end_per_testcase_failures, Failed}
    ] = Sum,
    [
        {groups_summary, {2, 1}},
        {eventually_ok_tests, 4},
        {end_per_testcase_failures, 1}
    ] = GrSum,
    [
        "CT results:",
        "    2 groups passed",
...
run_test_end_per_testcase_fails(_Config) ->
    ...
    [
        ...
        {total_failed, 0},
        {total_end_per_testcase_failures, 1},
        {end_per_testcase_failures, [{test_end_per_testcase_SUITE, test1}]}
    ] = Sum,
    [
        {groups_summary, {1, 0}},
        {eventually_ok_tests, 0},
...
read_summary(Spec) ->
    ...
    [GrDir] = filelib:wildcard(
        repo_dir(
            "ct_app/_build/test/logs/last/extras.tests." ++ Spec ++ "_SUITE.logs/*/groups.summary"
        )
    ),
...
summarise_results_cmd() ->
    "cd " ++ repo_dir("") ++
        " && priv/summarise-ct-results ct_app/_build/test/logs/last/ || echo CODE=$?".
